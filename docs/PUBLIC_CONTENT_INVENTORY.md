...
This inventory defines what may and may not enter the public repository. Classification must be reviewed again immediately before publication.
...
Future items remain private until explicit approval and final QA.

## Private and prohibited

- Editable DOCX files and other Research Note source files.
- Internal QA reports not explicitly authored for public release.
- Private source datasets, extracts and analytical tables.
- Spreadsheets and workbooks.
- Internal methodology and unpublished methodological notes.
- Private Gold strategy research or operational strategy material.
- Proprietary classifications and internal analytical taxonomies.
- Internal dashboard source repositories.
- Local filesystem paths or machine-specific settings.
- Environment files, credentials, API keys and secrets.
- CRM data, client information and contact databases.
- Personal documents.
